...
const LoadingScreen = ({ onComplete }) => {
  ...
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(ellipse at 50% 50%, #2b1100 0%, #000000 50%, #1a0a00 100%)",
      }}
    >
      ...
      <div className="relative z-10 flex items-center justify-center">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(255, 122, 0, 0.3) 0%, rgba(255, 122, 0, 0.1) 40%, transparent 70%)",
            filter: "blur(40px)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(255, 154, 60, 0.5) 0%, rgba(255, 122, 0, 0.2) 50%, transparent 70%)",
            filter: "blur(30px)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 30% 30%, #C8B1E4, #9B72CF 40%, #532B88)",
            boxShadow:
              "0 0 60px 30px rgba(255, 122, 0, 0.4), inset 0 0 30px rgba(255, 255, 255, 0.3)",
          }}
        >
          {/* Inner highlight */}
          <div
      ...
      {showText && (
        <div
          ref={textRef}
          className="relative z-20 mt-32 text-center"
          style={{ opacity: 0 }}
        >
          <h1 className="text-4xl md:text-5xl font-bold text-white tracking-tight mb-3">
            Ninad{" "}
            <span
              className="text-ninad-orange"
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, transparent, #9B72CF, transparent)",
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, transparent, #C8B1E4, transparent)",
